    ...
    <div class="bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                ...
                <a href="/tickets/new" class="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-bold text-gray-900"><?= isset($tickets) ? count($tickets) : 0 ?></p>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-200">
                            ...
                            <?php foreach ($tickets as $ticket): ?>
                                <tr class="hover:bg-gray-50 transition-colors">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        if ($ticket['status'] === 'Open') $statusClass = 'bg-red-100 text-red-800';
                                        if ($ticket['status'] === 'In Progress') $statusClass = 'bg-yellow-100 text-yellow-800';
                                        if ($ticket['status'] === 'Closed') $statusClass = 'bg-green-100 text-green-800';
                                        ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-4">
                                        ...
                                        <!-- Edit button -->
                                        <a href="/tickets/<?= esc($ticket['id']) ?>/edit"
                ...
                <?php else: ?>
                    <div class="text-center py-12">
                        ...
                        <div class="mt-6">
                            <a href="/tickets/new" class="inline-flex items-center px-4 py-2 bg-red-600 text-white text-sm font-medium rounded-md shadow-sm hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors">
                                <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                                </svg>
                                Create New Ticket
